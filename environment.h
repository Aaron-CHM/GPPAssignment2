...
namespace boundaryEnvironmentNS
{
    const int WIDTH = 16;   //image width 
    const int HEIGHT = 16;  //image height
    const int MIN_X = 0;   //left side coordinate of boundary 
    const int MAX_X = GAME_WIDTH;   //right side coordinate of boundary
    const int MIN_Y = 0;   //top side coordinate of boundary 
    const int MAX_Y = GAME_HEIGHT;   //bottom side cooardinate of boundary 
